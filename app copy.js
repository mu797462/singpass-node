...
<div class="field-item">
    ...
    <input id="loan-amount" type="text" name="loan-amount" placeholder="1000">
</div>
<div class="field-item">
    <label for="renovation-loan">Main Purpose for Loan</label>
    <input id="renovation-loan" type="text" name="renovation-loan" placeholder="Renovation Loan">
</div>
</div>
</p>
...
<div class="field-item">
    ...
    <input id="moneylender" type="text" name="moneylender" placeholder="No">
</div>
</div>
</p>
...
<div class="field-item">
    ...
    <input id="NRIC" type="text" name="NRIC" placeholder="S7380725E">
</div>
<div class="field-item">
    <label for="name">Name</label>
    <input id="name" type="text" name="name" placeholder="RATAN SHIVALI JOSHI">
</div>
</div>
</p>
<p class="s1" style="padding-top: 11pt;padding-left: 5pt;text-indent: 0pt;text-align: left;"></p>
...
<div class="input-field-grid">
<div class="field-item">
    <label for="alias-name">Hanyu Pinyin Alias Name</label>
    <input id="alias-name" type="text" name="alias-name" placeholder="">
</div>
<div class="field-item">
    <label for="nationality">Nationality</label>
    <input id="nationality" type="text" name="nationality" placeholder="SINGAPORE CITIZEN">
</div>
</div>
</p>
<p class="s1" style="padding-top: 11pt;padding-left: 5pt;text-indent: 0pt;text-align: left;"></p>
...
<div class="field-item">
    ...
    <input id="gender" type="text" name="gender" placeholder="MALE">
</div>
<div class="field-item">
    <label for="d-o-b">Date of Birth</label>
    <input id="d-o-b" type="text" name="d-o-b" placeholder="1973-08-09">
</div>
</div>
</p>
<p class="s1" style="padding-top: 11pt;padding-left: 5pt;text-indent: 0pt;text-align: left;"></p>
...
<div class="input-field-grid">
<div class="field-item">
    <label for="p-o-b">Place of Birth</label>
    <input id="p-o-b" type="text" name="p-o-b" placeholder="SINGAPORE">
</div>
<div class="field-item">
    <label for="race">Race</label>
    <input id="race" type="text" name="race" placeholder="INDIAN">
</div>
</div>
</p>
<p class="s1" style="padding-top: 11pt;padding-left: 5pt;text-indent: 0pt;text-align: left;"></p>
...
<div class="field-item">
    ...
    <input id="marital-status" type="text" name="marital-status" placeholder="MARRIED">
</div>
<div class="field-item">
    <label for="residential-status">Residential Status</label>
    <input id="residential-status" type="text" name="residential-status" placeholder="CITIZEN">
</div>
</div>
</p>
<p class="s1" style="padding-top: 11pt;padding-left: 5pt;text-indent: 0pt;text-align: left;"></p>
...
<div class="field-item">
    ...
    <input id="type-of-housing" type="text" name="type-of-housing" placeholder="">
</div>
<div class="field-item">
    <label for="private-residential">Ownership of Private Residential Property</label>
    <input id="private-residential" type="text" name="private-residential" placeholder="No">
</div>
</div>
</p>
<p style="padding-left: 5pt;text-indent: 0pt;line-height: 13pt;text-align: left;" />
...
<div class="input-field-grid">
<div class="field-item">
    <label for="pass-expiry-date">Pass Expiry Date</label>
    <input id="pass-expiry-date" type="text" name="pass-expiry-date" placeholder="">
</div>
</div>
</p>
<p style="padding-left: 5pt;text-indent: 0pt;line-height: 13pt;text-align: left;" />
...
<div class="field-item">
    ...
    <input id="mobile-number" type="text" name="mobile-number" placeholder="+6594891920">
</div>
<div class="field-item">
    <label for="home-number">Home Number</label>
    <input id="home-number" type="text" name="home-number" placeholder="">
</div>
<div class="field-item">
    <label for="email-address">Email Address</label>
    <input id="email-address" type="text" name="email-address" placeholder="myinfo34633@gmail.com">
</div>
</div>
</p>
<p class="s1" style="padding-top: 11pt;padding-left: 5pt;text-indent: 0pt;text-align: left;"></p>
...
<div class="field-item">
    ...
    <input class="lg-input" id="registered-address" type="text" name="registered-address" placeholder="148 HDB-BUKIT PANJANG #08-106 GANGSA ROAD Singapore 670148">
</div>
</div>
</p>
<p class="s1" style="padding-top: 11pt;padding-left: 5pt;text-indent: 0pt;text-align: left;"></p>
...
<td
    ...
    <p class="s5" style="padding-top: 0pt;padding-left: 4pt;text-indent: 4pt;text-align: left;">No. of
        Owners</p>
</td>
<td
...
<td
    style="width:102pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;padding:2pt; vertical-align: middle;">
    <p class="s5"
        style="padding-top: 0pt;padding-left: 8pt;padding-right: 7pt;text-indent: 0pt;text-align: center;">
        Lease Commencement Date</p>
</td>
<td
    style="width:70pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;padding:2pt; vertical-align: middle;">
    <p class="s5"
        style="padding-top: 0pt;padding-left: 8pt;padding-right: 7pt;text-indent: 5pt;text-align: left;">
        Date of Purchase</p>
</td>
<td
    style="width:82pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;padding:2pt; vertical-align: middle;">
    <p class="s5"
        style="padding-top: 0pt;padding-left: 5pt;padding-right: 5pt;text-indent: 0pt;text-align: center;">
        Outstanding HDB Loan Balance</p>
</td>
<td
    style="width:72pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;padding:2pt; vertical-align: middle;">
    <p class="s5"
        style="padding-top: 0pt;padding-left: 4pt;padding-right: 4pt;text-indent: 0pt;text-align: center;">
        Monthly Loan Instalment</p>
</td>
</tr>
<tr style="height:auto">
<td
    ...
    <p class="s6"
        ...
        148 HDB-BUKIT PANJANG #08-106 GANGSA ROAD Singapore 670148</p>
</td>
<td
    style="width:52pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;padding:2pt; vertical-align: middle;">
    <p class="s6" style="padding-left: 3pt;text-indent: 0pt;text-align: left;">2</p>
</td>
<td
    style="width:62pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;padding:2pt; vertical-align: middle;">
    <p class="s6"
...
<td
    style="width:102pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;padding:2pt; vertical-align: middle;">
    <p class="s6" style="padding-left: 3pt;text-indent: 0pt;text-align: left;">2016-01-19</p>
</td>
<td
    style="width:70pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;padding:2pt; vertical-align: middle;">
    <p class="s6" style="padding-left: 3pt;text-indent: 0pt;text-align: left;">2016-01-19</p>
...
<td
    style="width:82pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;padding:2pt; vertical-align: middle;">
    <p class="s6" style="padding-left: 3pt;text-indent: 0pt;text-align: left;">200000</p>
</td>
<td
    style="width:72pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt;padding:2pt; vertical-align: middle;"> 
    <p class="s6" style="padding-left: 3pt;text-indent: 0pt;text-align: left;">1500</p>
</td>
</tr>
</table>
<p style="text-indent: 0pt;text-align: left;"><br /></p>
<p class="s1" style="padding-top:8pt;padding-bottom:8pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">CPF Contributions History (up to 15 months)</p>
<table style="border-collapse:separate;margin-left:5pt;border: 1px solid #000;border-spacing: 4px; width: 100%;" cellspacing="0">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2022-08</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2021-12-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">1,950.00</p>
</td>
<td
    style="width:198pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 4pt;text-indent: 0pt;text-align: left;">WHIZ-INDIGO
        LTD</p>
</td>
</tr>
<tr style="height:20pt">
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2022-09</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-01-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2022-10</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-02-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2022-11</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-03-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2022-12</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-04-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2023-01</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-05-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2023-02</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-06-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2023-03</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-07-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2023-04</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-08-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2023-05</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-09-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2023-06</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-10-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2,000.00</p>
</td>
<td
    style="width:198pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 4pt;text-indent: 0pt;text-align: left;">WHIZ-INDIGO
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2023-07</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-11-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2023-08</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2022-12-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2023-09</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2023-01-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<td
    style="width:96pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 3pt;text-indent: 0pt;text-align: left;">2023-10</p>
</td>
<td
    style="width:107pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">2023-02-07
    </p>
</td>
<td
    style="width:105pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
...
<p style="text-indent: 0pt;text-align: left;"><br /></p>
<p class="s1" style="padding-bottom:5pt;padding-top: 3pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">Notice of Assessment
...
<td
    style="width:255pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s5" style="padding-top: 3pt;padding-left: 54pt;text-indent: 0pt;text-align: left;">Year of
        Assessment: 2019</p>
</td>
</tr>
<tr style="height:20pt">
...
<td
    style="width:255pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 4pt;text-indent: 0pt;text-align: left;">Type:
        ORIGINAL</p>
</td>
</tr>
<tr style="height:20pt">
...
<td
    style="width:255pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s6" style="padding-top: 1pt;padding-left: 4pt;text-indent: 0pt;text-align: left;">Assessable
        Income: 140000.00</p>
</td>
</tr>
...
<td
    style="width:255pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s5"
        style="padding-top: 3pt;padding-left: 4pt;text-indent: 0pt;line-height: 12pt;text-align: left;">
        Income Breakdown</p>
    <ul id="l2">
        <li data-list-text="•">
            <p class="s6" style="padding-left: 13pt;text-indent: -9pt;line-height: 13pt;text-align: left;">
                Employment: 140000.00</p>
        </li>
        <li data-list-text="•">
            <p class="s6" style="padding-left: 13pt;text-indent: -9pt;line-height: 13pt;text-align: left;">
                Trade:</p>
        ...
        <li data-list-text="•">
            <p class="s6" style="padding-left: 13pt;text-indent: -9pt;line-height: 14pt;text-align: left;">
                Interest:</p>
        </li>
    </ul>
</td>
...
<input type="checkbox" style="display: inline-block; width: auto; margin-right: 10pt;">
